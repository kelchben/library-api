...
// register(Patron), register(BookDescription)   ---->

	out.println(
			"\nRegister some Patrons to accounts -> returns Username of added patron:");
	...
	out.println(
			"\nRegister some books to catalog -> returns auto-generated Barcode to put on physical BookCopy:");
