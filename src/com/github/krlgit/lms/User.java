...
final class User implements Patron {
...
//---- OTHER ------------------------------------->
	 ...
	 * - should it be possible for a User to have different usernames? (there could be different libraries)
	 * - should username be in AccountEntry? Created from User fields?
	 * 
